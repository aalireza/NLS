...
menu_data = {
  'title': "NLS - Natural Language Steganography", 'type': MENU, 'subtitle': "Please select an option...",
  'options':[
    { 'title': "Encrypt", 'type': COMMAND, 'command':"" },
        { 'title': "Decrypt", 'type': MENU, 'subtitle': "Please select an option...",
          'options': [
          { 'title': "What is your message?", 'type': COMMAND, 'command': 'getstr()' },
